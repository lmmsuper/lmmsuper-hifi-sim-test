function [ wDenom ] = addWienerDenominatorWiener_3D(wd,sp,d,b)
...
elseif b==2
    ...
    otfVal2=otfVal2.*valAttenuation(rad1,sp.OtfProvider.attStrength/1.0,1*sp.OtfProvider.attFWHM)/1.0;
else
