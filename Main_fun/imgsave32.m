%%  
% Reference
%	K?ик?ek, P., Luke?, T., Ovesn?, M., Fliegel, K. & Hagen, G. M. SIMToolbox: a MATLAB toolbox for structured illumination fluorescence microscopy. Bioinformatics 32, 318иC320 (2015).

function imgsave32(IM, filename)
